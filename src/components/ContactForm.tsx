...
const ContactForm = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:hr@saturcinda.com?subject=Inquiry&body=${encodeURIComponent(emailBody)}`;
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        >
          <option value="Not specified">Select a product category</option>
