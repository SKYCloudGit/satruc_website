  ...
  const features = [
    {
      ...
      description:
        "We specialize in ultra-precise, repeatable production processes—ensuring consistent quality across a wide range of consumer-grade products.",
    },
    {
      icon: Shield,
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="mt-4 text-lg text-satruc-600">
            From concept to production, Satruc delivers precision-built
            solutions that meet the highest standards of quality, efficiency,
