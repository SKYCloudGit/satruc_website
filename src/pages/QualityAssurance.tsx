...
import bgImage from "../../public/Images/qa.jpg";
import { useInView } from 'react-intersection-observer';
import Image1 from "../../public/Images/qa1.jpg";
import Image2 from "../../public/Images/qa2.jpg";
...
export default function QualityAssurence() {
  ...
  Quality That Powers Every 
            ...
            Our commitment to rigorous testing, expert oversight, and global standards ensures consistent manufacturing excellence across smart living and industrial applications.
            </p>
            <Button 
              size="lg" 
...
Unmatched Inspection Standards        </h2>
        <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
Our QA professionals monitor every step of the manufacturing process to ensure each unit meets strict visual, electrical, and environmental benchmarks.
        </p>
      </div>
...
Certified Quality Systems
        ...
        <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
Satruc operates under ISO 9001:2015 and other international frameworks—ensuring that every product is traceable, reliable, and audit-ready.        </p>
      </div>
    </div>
  </div>
</section>
              ...
              {[
  {
    ...
    description: "Every unit undergoes rigorous quality checks throughout the production cycle—ensuring full compliance with industrial and lifestyle standards."
  },
  {
    icon: Shield,
    title: "Globally Certified Systems",
    description: "We follow globally recognized quality systems, including ISO 9001:2015, to deliver trusted and repeatable manufacturing outcomes."
  },
  {
    icon: Award,
    title: "Built for Dependability",
    description: "Our quality benchmarks are continuously refined to meet the performance expectations of tomorrow's smart and industrial systems."
  },
  {
    icon: Users,
    title: "QA by Experts",
    description: "A specialized quality assurance team oversees each stage—ensuring durability, safety, and consistency across all production lines."
  }
].map((feature, index) => (
