  ...
  const timeline = [
    {
      ...
      description: 'Satruc Appliances was established as a small workshop in Hyderabad, focused on mechanical regulators.'
    },
    {
      year: '2019',
      title: 'Manufacturing Plant',
      description: 'Expanded operations with our first dedicated manufacturing facility in Fab City Hyderabad.'
    },
    {
      year: '2020',
      title: 'Electronic Innovation',
      description: 'Pioneered our first electronic gas regulation system, setting new industry standards.'
    },
    {
      year: '2020',
      title: 'International Expansion',
      description: 'Began exports to Middle East and Southeast Asian markets, establishing global presence.'
    },
    {
      year: '2022',
      title: 'Smart Technology Integration',
      description: 'Launched SmartFlow series with IoT connectivity and remote monitoring capabilities.'
    },
    {
      year: '2025',
      title: 'R&D Excellence Center',
      description: 'Opened state-of-the-art research facility focused on next-generation regulation technologies.'
    }
  ];
...
For a decade, Satruc Appliances has pioneered precision manufacturing, setting industry standards through continuous innovation and uncompromising quality.                </p>
                <div className="flex flex-wrap gap-4">
                  <div className="flex items-center">
                    <Clock className="h-5 w-5 text-satruc-accent-600 mr-2" />
                    <span className="text-satruc-700 text-sm">8+ Years Experience</span>
                  </div>
                  <div className="flex items-center">
                    <Users className="h-5 w-5 text-satruc-accent-600 mr-2" />
                    <span className="text-satruc-700 text-sm">50+ Employees</span>
                  </div>
                  <div className="flex items-center">
                    <ShieldCheck className="h-5 w-5 text-satruc-accent-600 mr-2" />
                    <span className="text-satruc-700 text-sm">ISO 9001:2015 Certified</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="bg-satruc-50 p-8 rounded-lg">
                ...
                <h2 className="text-2xl font-bold text-satruc-900 mb-4">Our Vision</h2>
                <p className="text-satruc-700">
To be the global leader in innovative manufacturing solutions, driving industry standards through constant innovation and excellence in engineering.                </p>
              </div>
              <div className="bg-satruc-accent-50 p-8 rounded-lg">
                <div className="w-12 h-12 bg-satruc-accent-600 text-white rounded-full flex items-center justify-center mb-6">
                  <BarChart className="h-6 w-6" />
                </div>
                <h2 className="text-2xl font-bold text-satruc-900 mb-4">Our Mission</h2>
                <p className="text-satruc-700">
To enhance safety and efficiency through precision engineering, delivering reliable manufacturing solutions that exceed customer expectations and set new industry standards.                </p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="mt-4 text-lg text-satruc-300">
              These foundational principles guide our decisions, shape our culture, and drive our commitment to excellence.
            </p>
          </div>
           ...
           {[
  {
    icon: ShieldCheck,
    title: 'Safety First',
    description: 'We engineer solutions where safety is built into every step, consistently exceeding global manufacturing standards.'
  },
  {
    icon: Award,
    title: 'Uncompromising Quality',
    description: 'Every component and system undergoes rigorous testing to deliver exceptional performance and long-term reliability.'
  },
  {
    icon: Lightbulb,
    title: 'Continuous Innovation',
    description: 'We invest heavily in research and development to drive innovation across all areas of advanced manufacturing.'
  },
  {
    icon: Users,
    title: 'Customer Partnership',
    description: 'We build long-term partnerships by delivering responsive support and tailored manufacturing solutions for each client’s needs.'
  }
].map((value, index) => (
              <div 
                key={index} 
              ...
              >
                ...
                <p className="text-satruc-300 text-sm">
                  {value.description}
                </p>
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-satruc-700 mb-8">
                Our advanced manufacturing facilities combine precision engineering with cutting-edge technology to deliver products of unparalleled quality and reliability.
              </p>
                ...
                {[
  {
    ...
    description: 'Our ISO 9001:2015 certified facility in Hyderabad houses automated production lines, precision machinery, and robust quality control systems.'
  },
  {
    icon: Briefcase,
    title: 'In-House R&D Department',
    description: 'Our dedicated research team drives innovation across multiple domains,  including break throughs in regulation and control technologies.'
  },
  {
    icon: GraduationCap,
    title: 'Technical Excellence',
    description: 'Our workforce includes highly skilled engineers with deep expertise in advanced manufacturing, and intelligent control systems.'
  }
].map((facility, index) => (
                  <div key={index} className="flex">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-satruc-900 mb-2">{facility.title}</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-lg overflow-hidden shadow-sm h-48 md:h-64 bg-satruc-accent-600 text-white p-6 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-white/90 text-sm">Every product undergoes rigorous testing to ensure perfect performance.</p>
                  </div>
                <div className="text-4xl font-bold"></div> {/*can add percentage in the div*/}
                </div>
              </div>
              <div className="space-y-4">
                <div className="rounded-lg overflow-hidden shadow-sm h-64 md:h-80 bg-satruc-50 p-6">
                  <h3 className="text-xl font-semibold text-satruc-900 mb-3">Cutting-Edge Technology</h3>
                  <p className="text-satruc-700 text-sm mb-4">Our production processes incorporate the latest advancements in precision manufacturing.</p>
                  <img 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            {/* <h2 className="text-3xl font-bold text-white mb-6">
              Partner with Satruc for Your Manufacturing Needs
            </h2>
            <p className="text-xl text-white/90 mb-8">
              Experience the difference that precision engineering and decades of expertise can make.
            </p> */}
