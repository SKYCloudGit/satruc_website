...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: "Call Us",
      details: ["+91-9880019590"],
      link: "tel:+91-9880019590",
      linkText: "Call Now",
    },
    {
      icon: Mail,
      title: "Email Us",
      details: ["hr@satrucindia.com"],
      link: "mailto:hr@satrucindia.com",
      linkText: "Send Email",
    },
    {
      icon: Clock,
      title: "Business Hours",
      details: ["Monday - Saturday: 9:00 AM - 5:30 PM"],
      link: undefined,
      linkText: undefined,
    },
  ];
  ...
  const factoryLocations = [
    {
      city: "Hyderabad",
      address:
        "Plot no : S-4/B,E-CITY,RAVIRYALA VILLAGE,Hyderabad,Telangana 501510, India",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-satruc-700 mb-8">
              Whether you're looking to partner with us, join our team, or
              simply ask a question — we're all ears. Fill out the form and
              we'll get back to you shortly.
            </p>
            <a
              href="https://docs.google.com/forms/d/e/1FAIpQLSdHld1UfPGCyVOY7KQPQrW9dD78yYamVZFkfT_HT_66hnpiww/viewform?embedded=true" // ← replace with your actual Google Form link
              target="_blank"
                ...
                <div className="space-y-6">
                  {officeLocations.map((office, index) => (
                    <div
                      key={index}
                      className={
                        index > 0 ? "pt-4 border-t border-satruc-100" : ""
                      }
                    >
                      ...
                      <p className="text-satruc-600 text-sm">{office.phone}</p>
                    </div>
                  ))}
                </div>
              </div>
