...
import bgImage from "../../src/assets/randd (1).webp";
import { useInView } from "react-intersection-observer";
import Image1 from "../../src/assets/randd (2).jpg";
import Image2 from "../../src/assets/randd (3).jpg";
        ...
        <section className="relative flex flex-col md:flex-row items-center justify-between overflow-hidden bg-white py-40 px-6">
          <div className="md:w-1/2 max-w-xl z-10 text-center md:text-left space-y-6">
            ...
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
              Our R&D team is committed to driving innovation in smart products
              through next-gen technology, data intelligence, and
              sustainability.
            </p>
            <Button
              size="lg"
            ...
            <div className="w-full md:w-1/2 flex flex-col">
              ...
              >
                ...
                <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl">
                  Our R&D engineers lead with experimentation and data-driven
                  design—pushing the boundaries of what's possible in smart
                  products, IoT communication, and embedded intelligence. Every
                  concept undergoes intensive prototyping, validation, and
                  refinement before market deployment.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                  Satruc’s R&D processes follow ISO 9001:2015 and global
                  innovation standards—ensuring every prototype is traceable,
                  rigorously tested, and ready for scalable deployment.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-26">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                We drive innovation through structured experimentation, advanced
                prototyping, and continuous improvement—ensuring every
                breakthrough is scalable, sustainable, and future-ready.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Our R&D team rapidly builds and tests new ideas using agile prototyping frameworks and real-world simulations.",
                },
                {
                  icon: Microscope,
                  title: "Standards-Based Research",
                  description:
                    "We align our R&D processes with international standards like ISO 9001:2015 to ensure reliable and validated innovation.",
                },
                {
                  icon: Award,
                  title: "Scalable Product Innovation",
                  description:
                    "Breakthroughs are designed with scalability in mind—ensuring smooth transition from lab to large-scale production.",
                },
                {
                  icon: Users,
                  title: "Cross-Functional Expertise",
                  description:
                    "Engineers, data scientists, and field experts collaborate to explore new possibilities across IoT, analytics, and embedded systems.",
                },
              ].map((feature, index) => (
                <Card
                  key={index}
