...
“Manufacturing the Invisible Intelligence”
            ...
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
              Behind every seamless interaction in modern homes is robust manufacturing. At Satruc, we produce the underlying components that enable intuitive control and reliable connectivity across smart living ecosystems.
              </p>
            <Button 
              size="lg" 
...
“Enabling Comfort at the Tap of a Finger”
        ...
        <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
Our manufacturing excellence delivers precision-built systems that support responsive, intelligent lifestyles. We ensure every moment—from comfort to control—is powered by quality you can trust.   </p>   </div>
...
“Engineering Everyday Intelligence”
        ...
        <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
From digital design to large-scale production, Satruc provides the manufacturing backbone for smart living. We enable global brands to bring connected environments to life—dependably, precisely, and at scale.        </p>
      </div>
    </div>
  </div>
</section>
...
We apply rigorous quality controls across every step of production—ensuring each smart-living innovation is dependable, precise, and ready for the future.              </p>
            </div>
             ...
             { [
{
  ...
  description: "Our devices are optimized for effortless connectivity across home ecosystems, ensuring a smooth and intuitive user experience."
},
{
  icon: Shield,
  title: "Lifestyle-Ready Compliance",
  description: "We adhere to modern smart-living standards focused on energy efficiency, data privacy, and seamless interoperability."
},
{
  icon: Award,
  title: "Tailored for Modern Living",
  description: "Our design-first approach delivers personalized comfort and technology that adapts to your lifestyle needs."
},
{
  icon: Users,
  title: "Human-Centric Validation",
  description: "Every product is tested for real-world usability, aesthetics, and ergonomics to ensure it blends naturally into everyday life."
}
